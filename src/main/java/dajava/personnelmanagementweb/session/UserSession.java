package dajava.personnelmanagementweb.session;
...
public class UserSession implements UserRepository {
    @Autowired
    ...
    public boolean Login(String username, String password) {
        ...
        try {
            User user =(User) session.createQuery("select from user where username='" + username +"' and password ='"+password+"'").getSingleResult();
            return user != null;
        }
        catch (Exception e) {
            return false;
